...
#    Updated: 2025/10/29 00:25:29 by dde-fite         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES		:= core/ft_printf.c core/argument_getters.c core/interruption_writers.c \
				utils/printing_helpers.c utils/variadic_getter.c utils/number_helpers.c \
				conversions/int_conversion.c conversions/char_conversion.c conversions/uint_conversion.c conversions/str_conversion.c conversions/hex_conversion.c
SRC_FOLDER		= src
